...
RUN python3.9 -m dqn_zoo.sketch_dqn.networks_test
RUN python3.9 -m dqn_zoo.sketch_dqn.feature_maps_test
RUN python3.9 -m dqn_zoo.sketch_dqn.run_atari_test

# Allow running container as an executable. E.g. to run Sketch-DQN:
